...
public class PersonNamer : Singleton<PersonNamer>
{
    ...
    private readonly (string, float)[] _turkishMaleNames = {
        ("Ahmet", 0.0406f), ("Ali", 0.0394f), ("Mehmet", 0.0357f), ("Mustafa", 0.0318f), ("�brahim", 0.0229f),
        ("Osman", 0.0184f), ("H�seyin", 0.0169f), ("Hasan", 0.0153f), ("Murat", 0.0148f), ("Yusuf", 0.0139f),
        ("Emre", 0.0129f), ("Kemal", 0.0127f), ("Ertu�rul", 0.0125f), ("Cemal", 0.0121f), ("Yunus", 0.0119f),
        ("Taha", 0.0116f), ("Ahmad", 0.0115f), ("U�ur", 0.0113f), ("Enes", 0.0109f), ("Ahmad", 0.0106f),
        ("Emin", 0.0105f), ("Fatih", 0.0102f), ("Halil", 0.0101f), ("Yakup", 0.0101f), ("Ercan", 0.0098f),
        ("Hakan", 0.0096f), ("Furkan", 0.0093f), ("�mer", 0.0093f), ("Adem", 0.0092f), ("Can", 0.0092f),
        ("Yasin", 0.0091f), ("Fikret", 0.0090f), ("Efe", 0.0089f), ("Necmettin", 0.0088f), ("Abdullah", 0.0087f),
        ("Berk", 0.0086f), ("Selim", 0.0085f), ("Hac�", 0.0084f), ("Mert", 0.0083f), ("Serdar", 0.0083f),
        ("Umut", 0.0083f), ("Ege", 0.0082f), ("Salih", 0.0082f), ("Yi�it", 0.0082f), ("Ya�ar", 0.0081f),
        ("Nihat", 0.0080f), ("Kenan", 0.0079f), ("Cemil", 0.0078f), ("Bar��", 0.0077f), ("Serkan", 0.0076f),
        ("�ahin", 0.0076f), ("Arif", 0.0075f), ("Emrah", 0.0075f), ("Ayd�n", 0.0074f), ("Yavuz", 0.0074f),
        ("Nuri", 0.0073f), ("Erdal", 0.0072f), ("Y�lmaz", 0.0072f), ("B�lent", 0.0071f), ("Recep", 0.0071f),
        ("Samet", 0.0070f), ("Orhan", 0.0069f), ("Musa", 0.0068f), ("�smail", 0.0067f), ("Metin", 0.0066f),
        ("Cengiz", 0.0065f), ("�lker", 0.0065f), ("G�khan", 0.0064f), ("Ahmed", 0.0063f), ("Ali �hsan", 0.0063f),
        ("Tuncay", 0.0063f), ("Y�ld�r�m", 0.0063f), ("Aykut", 0.0062f), ("Mikail", 0.0062f), ("Nihat", 0.0062f),
        ("Onur", 0.0062f), ("Selahattin", 0.0062f), ("M�cahit", 0.0061f), ("Necati", 0.0061f), ("�evket", 0.0061f),
        ("�enol", 0.0060f), ("Yal��n", 0.0060f), ("Koray", 0.0059f), ("Erhan", 0.0058f), ("Kadir", 0.0058f),
        ("Deniz", 0.0057f), ("Hakan", 0.0057f), ("Bora", 0.0056f), ("Cihan", 0.0056f), ("Sad�k", 0.0056f),
        ("Fikri", 0.0055f), ("Erg�n", 0.0054f), ("Orkun", 0.0054f), ("Zeki", 0.0054f), ("Bekir", 0.0053f),
        ("Fuat", 0.0053f), ("Hilmi", 0.0053f), ("Necmi", 0.0053f), ("Zafer", 0.0053f), ("Muharrem", 0.0052f),
        ("Mehdi", 0.0051f), ("Burak", 0.0050f), ("Ekrem", 0.0050f), ("Emin �a�lar", 0.0050f), ("G�rkan", 0.0050f),
        ("Oktay", 0.0050f), ("Orhan Can", 0.0050f), ("Eren", 0.0049f), ("R�dvan", 0.0049f), ("�zzet", 0.0048f),
        ("Yasir", 0.0048f), ("Bartu", 0.0047f), ("H�seyin Ali", 0.0047f), ("Taylan", 0.0047f), ("Abdurrahman", 0.0046f),
    };

    private readonly (string, float)[] _turkishFemaleNames = {
        ("A�elya", 0.03f), ("Asl�", 0.09f), ("Ay�e", 0.12f), ("Bade", 0.02f), ("Beg�m", 0.03f),
        ("Belgin", 0.01f), ("Belgin", 0.02f), ("Berna", 0.01f), ("Berrin", 0.03f), ("Bet�l", 0.01f),
        ("Beyza", 0.02f), ("Binnur", 0.01f), ("Buse", 0.05f), ("Canan", 0.01f), ("Cansu", 0.02f),
        ("Cemre", 0.02f), ("Ceyda", 0.01f), ("Ceylan", 0.03f), ("�a�la", 0.02f), ("Damla", 0.04f),
        ...
        ("Gamze", 0.03f), ("Gizem", 0.04f), ("G�l", 0.01f), ("G�l�in", 0.01f), ("G�lay", 0.02f),
        ("G�lnur", 0.01f), ("G�l�ah", 0.02f), ("G�lten", 0.01f), ("G�zin", 0.01f), ("Hale", 0.01f),
        ("Hande", 0.04f), ("Hasibe", 0.01f), ("Hatice", 0.06f), ("Hazal", 0.03f), ("Hilal", 0.04f),
        ("Ilg�n", 0.01f), ("Irmak", 0.02f), ("Kader", 0.02f), ("Kamile", 0.01f), ("K�bra", 0.05f),
        ("Lale", 0.02f), ("Merve", 0.08f), ("Mine", 0.02f), ("Nagehan", 0.01f), ("Nalan", 0.01f),
        ("Necmiye", 0.01f), ("Neslihan", 0.04f), ("Nida", 0.01f), ("Nihal", 0.01f), ("Nur", 0.03f),
        ("Nuran", 0.01f), ("Nuray", 0.03f), ("�zge", 0.03f), ("�zlem", 0.06f), ("P�nar", 0.05f),
        ("Rabia", 0.01f), ("Reyhan", 0.02f), ("Sabiha", 0.01f), ("Sad�k", 0.01f), ("Seda", 0.03f),
        ("Selda", 0.02f), ("Sevgi", 0.02f), ("Sevil", 0.01f), ("Sevim", 0.02f), ("Sezen", 0.01f),
        ("Sibel", 0.03f), ("Simge", 0.01f), ("Sinem", 0.05f), ("Song�l", 0.02f), ("�ebnem", 0.01f),
        ("�enay", 0.01f), ("�ule", 0.01f), ("Tu�ba", 0.02f), ("T�lin", 0.01f), ("T�may", 0.01f),
        ("T�rkan", 0.01f), ("U�ur", 0.01f), ("�mit", 0.01f), ("�mm�", 0.01f), ("Yasemin", 0.06f),
        ("Yelda", 0.01f), ("Yeliz", 0.02f), ("Y�ksel", 0.01f), ("Zarife", 0.01f), ("Zehra", 0.04f),
        ("Zekiye", 0.01f),
    };

    private readonly string[] _turkishSurnames = new string[] {
        "Acar", "Akba�", "Akg�n", "Aksoy", "Akta�", "Aky�z", "Ari", "Arslan",
        "Atalay", "Atasoy", "Aydo�an", "Ayd�n", "Ayg�n", "Aykut", "Aypar", "Aysel",
        "Aysu", "Ayy�ld�z", "Ay�e", "Ayta�", "Babacan", "Bayar", "Bayer", "Baykara",
        "Bayrak", "Bayram", "Baysal", "Bekta�", "Be�erler", "Beyaz", "Bilge",
        "Birinci", "Bo�a", "Bozkurt", "Can", "Canan", "Cengiz", "�elik", "Demir",
        "Deniz", "Do�an", "Duman", "Durak", "Duru", "Duygu", "Erdem", "Erdin�",
        "Erdo�an", "Erk�l��", "Erol", "Ers�z", "G�r", "G�ner", "G�ne�", "G�rsel",
        "G�zel", "�lhan", "�nan", "Kahraman", "Kaplan", "Kara", "Karaca", "Karakaya",
        "Karaku�", "Kasap", "Kaya", "K�l��", "K�van�", "Ko�", "Korkmaz", "Kurt",
        "Karaku�", "Mutlu", "�zcan", "�zdemir", "�zen", "�zy�rek", "S�nmez",
        "S�leyman", "�ahin", "�anl�", "�en", "�im�ek", "Ta�", "Tuncel", "T�rk",
        "Uzun", "Uzman", "Yal��n", "Yaman", "Yap�c�", "Yavuz", "Y�ld�r�m",
        "Y�lmaz", "Yald�z", "Y�ld�z",
    };
